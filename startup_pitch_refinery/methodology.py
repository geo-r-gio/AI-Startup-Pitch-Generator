...
#                 adaptive_retry_enabled = strategy != "adaptive_no_retry"
#                 adaptive_checkpoint_enabled = strategy != "adaptive_no_checkpoint"
#                 if strategy == "adaptive_controller" and paired_adaptive_no_retry_state is not None:
...
#                     start = time.perf_counter() - (paired_adaptive_no_retry_runtime + continuation_runtime)
#                 else:
#                     state = adaptive_runner.run(
#                         idea=idea,
#                         thread_id=f"{thread_prefix}-{strategy}-{run_idx}",
...
#     }
#     json_path.write_text(json.dumps(paper_json, indent=2), encoding="utf-8")
#     return {"paper_json": str(json_path), "paper_csv": str(csv_path)}
...
# #     claim_units_total = len(validation.get("claim_units", []) if validation else [])
# #     failing_claim_count = len(validation.get("failing_claims", []) if validation else [])
# #     unsupported_material_claim_count = _safe_int(
# #         validation.get("unsupported_material_claim_count", 0) if validation else 0,
# #         0,
# #     )
# #     low_claim_count_flag = (
# #         1
...
# #         "retry_roi_estimate": float(state.get("retry_roi_estimate", 0.0) or 0.0),
# #         "material_failing_claim_count_last": _safe_int(
# #             last_retry_decision.get("material_failing_claim_count", 0), 0
# #         ),
# #         "specific_repair_claim_count_last": _safe_int(
# #             last_retry_decision.get("specific_repair_claim_count", 0), 0
# #         ),
# #         "accepted_patch_count": _safe_int(state.get("accepted_patch_count", 0), 0),
# #         "rejected_patch_count": _safe_int(state.get("rejected_patch_count", 0), 0),
# #         "over_decomposition_flag": 1 if bool(state.get("over_decomposition_flag", False)) else 0,
...
# #         "retry_expected_gain_last_mean",
# #         "retry_roi_last_mean",
# #         "retry_roi_estimate_mean",
# #         "material_failing_claim_count_last_mean",
# #         "specific_repair_claim_count_last_mean",
# #         "accepted_patch_count_mean",
# #         "rejected_patch_count_mean",
# #         "over_decomposition_flag_mean",
# #         "retry_effectiveness_mean",
# #         "raw_retry_score_delta_mean",
# #         "checkpoint_saved_score_mean",
# #         "focused_repair_search_count_mean",
...
# #             "retry_roi_estimate": metrics.get("retry_roi_estimate", 0.0),
# #             "material_failing_claim_count_last": metrics.get(
# #                 "material_failing_claim_count_last", 0
# #             ),
# #             "specific_repair_claim_count_last": metrics.get(
# #                 "specific_repair_claim_count_last", 0
# #             ),
# #             "accepted_patch_count": metrics.get("accepted_patch_count", 0),
# #             "rejected_patch_count": metrics.get("rejected_patch_count", 0),
# #             "over_decomposition_flag": metrics.get("over_decomposition_flag", 0),
...
# #             "claim_units_total": metrics.get("claim_units_total", 0),
# #             "failing_claim_count": metrics.get("failing_claim_count", 0),
# #             "unsupported_material_claim_count": metrics.get(
